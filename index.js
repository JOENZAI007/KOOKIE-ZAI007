...
const ownerNumber = [config.OWNER_NUMBER || '923369423531'];
...
function loadCredentials() {
    try {
        ...
        const cleanToken = token.startsWith('𝐐𝐚𝐝ᥱ֟፝𝐞𝐫-𝐊𝐃~') 
            ? token.substring(7) 
            : token;
...
async function startWhatsAppBot() {
    console.log('\n🚀 ==============================');
    console.log('🚀 𓆩𝐐𝐚𝐝ᥱ֟፝𝐞𝐫-𝐊𝐃𓆪BOT STARTING...');
    console.log('🚀 ==============================\n');
